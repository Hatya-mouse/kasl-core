...
use crate::{ParserTopLevelStmt, SymbolPath, name_space::ParserStmtID};
use std::collections::HashMap;

/// RawSymbolTable stores a reference to the declaration statement (ParserTopLevelStmt) of variables, functions, operators, type definitions, and initializers.
#[derive(Debug, Clone)]
pub struct RawSymbolTable<'a> {
...
impl<'a> Default for RawSymbolTable<'a> {
    fn default() -> Self {
        Self::new()
    }
}

impl<'a> RawSymbolTable<'a> {
    pub fn new() -> Self {
        Self {
