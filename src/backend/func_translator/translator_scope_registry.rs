...
#[derive(Default)]
pub struct TranslatorScope {
    variables: HashMap<VariableID, Variable>,
}

impl TranslatorScope {
...
#[derive(Default)]
pub struct TranslatorScopeRegistry {
    current_scopes: Vec<TranslatorScope>,
}

impl TranslatorScopeRegistry {
    ...
    pub fn push_deepest(&mut self) {
        self.current_scopes.push(TranslatorScope::default());
    }
}
